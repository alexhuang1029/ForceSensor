...
pi.set_PWM_dutycycle(LED_PIN, 85)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 84)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 83)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 82)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 81)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 80)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 79)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 78)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 77)
time.sleep(0.25)
pi.set_PWM_dutycycle(LED_PIN, 76)
time.sleep(0.25)
